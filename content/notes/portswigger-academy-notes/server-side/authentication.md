...
![Burp Intruder with the username field marked as a payload position](/notes/portswigger-academy-notes/username-enum-intruder.png "Sniper attack, username field selected, candidate wordlist loaded")
...
![Intruder results sorted by length, showing one outlier response](/notes/portswigger-academy-notes/username-enum-results.png "One row's length differs from the rest. That's the hit.")
...
![My Account page after logging in with the enumerated credentials](/notes/portswigger-academy-notes/username-enum-success.png "Lab solved")
