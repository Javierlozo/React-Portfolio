...
date: "2026-04-28"
thumbnail: "/blog/llm-audit-npm-page.png"
tags:
  - ai-security
  - llm-security
  - static-analysis
...
> Want the rules side by side without reading the whole post? **[See all 5 rules at /llm-audit](/llm-audit)** with vulnerable / safe code blocks, OWASP mappings, and the canonical fix for each.
...
> **Update (August 2026):** v1 is complete — twelve rules, covering LLM01, LLM02,
> LLM06, LLM07, LLM08, and LLM10. The five below are where it started. The
> current list is on the [llm-audit page](/llm-audit).
