...
> Want the rules side by side without reading the whole post? **[See every rule at /llm-audit](/llm-audit)** with vulnerable / safe code blocks, OWASP mappings, and the canonical fix for each.
