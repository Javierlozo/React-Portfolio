...
export default function PortfolioSlider() {
  ...
  return (
    <section id="portfolio" className={`py-20 ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          {/* Mini Grid Summary */}
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12 p-6 rounded-xl ${
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <div className="flex flex-wrap gap-2 mb-8">
                        {project.techStack.map((tech) => (
                          <span
                            key={tech}
                            className={`px-3 py-1 text-sm font-medium rounded-full border transition-all duration-300 hover:scale-105 ${
                              theme === 'dark' 
