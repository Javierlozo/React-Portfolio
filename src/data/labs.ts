...
export const LABS: CybersecurityLab[] = [
  ...
  },
  {
    id: 6,
    courseSlug: "sec401",
    slug: "mobile-device-backup-recovery",
    title: "Lab 2.3 - Mobile Device Backup Recovery",
    course: "SEC401 - Defense in Depth",
    focus: "Data Security & DLP",
    level: "SEC401",
    context: "",
    summary: "Mobile device backup recovery and forensic analysis.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    level: "SEC401",
    context: "",
    summary: "Network discovery and host enumeration techniques.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    id: 8,
    courseSlug: "sec401",
    slug: "binary-file-analysis",
    title: "Lab 3.2 - Binary File Analysis and Characterization",
    course: "SEC401 - Vulnerability Management and Response",
    focus: "Malware Analysis",
    level: "SEC401",
    context: "",
    summary: "Binary file analysis, characterization, and identification techniques.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    level: "SEC401",
    context: "",
    summary: "Web application vulnerability exploitation techniques.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    title: "Lab 3.4 - SIEM Log Analysis",
    course: "SEC401 - Vulnerability Management and Response",
    focus: "SIEM & Log Analysis",
    level: "SEC401",
    context: "",
    summary: "SIEM log analysis for threat detection and investigation.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    level: "SEC401",
    context: "",
    summary: "Hashing algorithms and cryptographic validation techniques.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    title: "Lab 4.2 - Encryption and Decryption",
    course: "SEC401 - Data Security Technologies",
    focus: "Cryptography",
    level: "SEC401",
    context: "",
    summary: "Symmetric and asymmetric encryption and decryption operations.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    level: "SEC401",
    context: "",
    summary: "Intrusion detection and network security monitoring using Snort3 and Zeek.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    id: 14,
    courseSlug: "sec401",
    slug: "windows-process-exploration",
    title: "Lab 5.1 - Windows Process Exploration",
    course: "SEC401 - Windows and Azure Security",
    focus: "Windows Security",
    level: "SEC401",
    context: "",
    summary: "Windows process exploration and analysis for threat hunting.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    id: 15,
    courseSlug: "sec401",
    slug: "windows-filesystem-permissions",
    title: "Lab 5.2 - Windows Filesystem Permissions",
    course: "SEC401 - Windows and Azure Security",
    focus: "Windows Security",
    level: "SEC401",
    context: "",
    summary: "Windows filesystem permissions and access control configuration.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    level: "SEC401",
    context: "",
    summary: "Applying and enforcing Windows system security policies.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    level: "SEC401",
    context: "",
    summary: "Using PowerShell for automation, security tasks, and operations at scale.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
  ...
  },
  {
    ...
    title: "Lab 6.2 - Linux Containers",
    course: "SEC401 - Containers, Linux and Mac Security",
    focus: "Linux Security",
    level: "SEC401",
    context: "",
    summary: "Linux container security, isolation, and management.",
    whyThisMatters: "",
    tools: [],
    steps: [],
    outcome: "",
